    ...
    return (
        <>
            <section className="flex  items-center justify-center h-screen">
                <div className=" inset-0  h-full w-full items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)]">
                    <div className="container mx-auto px-4 py-8 text-white">
                        <h1 className="text-2xl font-bold mb-4">Acerca de la Galería de Parques Nacionales</h1>
                        <p className="mb-4">
                            Bienvenido a nuestra galería de imágenes de parques nacionales de Canadá y Estados Unidos. Este proyecto tiene como objetivo proporcionar una experiencia visual de la belleza natural y la diversidad de los parques nacionales de América del Norte.
                        </p>
                        <p className="mb-4">
